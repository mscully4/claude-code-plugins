---
name: mmoney
description: Use when working with Monarch Money via the mmoney CLI to fetch accounts, balances, transactions, categories, tags, holdings, budgets, cashflow, recurring subscriptions, or institutions — and for personal finance questions like net worth, savings rate, spending by category, or emergency fund coverage.
---
